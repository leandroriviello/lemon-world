...
export const LanguageToggle = () => {
  ...
  return (
    <div className="relative h-10 rounded-full border border-white/10 bg-white/5 backdrop-blur-md shadow-[0_6px_20px_rgba(0,0,0,0.25)] overflow-hidden">
      <div
        className={`absolute top-1 bottom-1 w-[calc(33.333%-0.5rem)] rounded-full transition-[left] duration-300 ease-out ring-1 ring-black/5
        ...
        style={{ left: `calc(0.25rem + ${items.indexOf(lang)} * 33.333%)` }}
        aria-hidden
      />
